...
44. Поддержка плагинов. Для загрузки плагинов необходимо в каталоге с исполняемым файлом программы создать папку “ Plugins” и поместить доступные плагины в эту папку. Плагины будут загружены при удачной авторизации в домене.
